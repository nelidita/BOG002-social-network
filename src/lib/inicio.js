export const pantallaInicio = () => {
  ...
  const contenidoinicio = `
    ...
    <div class = "logoBotones">
      ...
      <button href="#/Login" class="botonesInicio" id="btnIniciarSesion" type="submit"> Iniciar sesión </button>
      <button href="#/Resgistro" class="botonesInicio" id="btnRegistrate" type="submit"> Regístrate </button>
    </div>
  `;
